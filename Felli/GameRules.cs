    ...
    public class GameRules
    {
        ...
        public void DisplayGameRules(Renderer rend)
        {
            ...
            rend.Render("Welcome to Felli!\nA 2 (two) player turn based "
                ...
                + "They can jump over an opponent's players, eliminating that"
                + "players, and landing afterwards on an adjacent open space. "
                + "\n\tIf there is no adjacent open space next to the consumed"
                + "players then it can not be eliminated (like in checkers)."
                + "\n\tEach player can only move 1 (one) players per turn.\n"
